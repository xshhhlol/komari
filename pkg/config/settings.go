...
type Settings struct {
	...
	// 分组全局显示顺序（";" 分隔的分组名）；前端筛选/选择按此排序，未列出的分组按字母序追加在后
	GroupOrder string `json:"group_order" default:""`
	// 通知
	...
	// 节点 IP 被墙/恢复通知（依赖 ping 任务的 block_check 判定）
	CnBlockedNotificationEnabled bool    `json:"cn_blocked_notification_enabled" default:"true"`
...
const (
	...
	CnBlockedNotificationEnabledKey = "cn_blocked_notification_enabled"
